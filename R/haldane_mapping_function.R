...
#' 
#' @seealso \code{\link{calculate_genotype_probabilities}} for genotype probability calculations
#' 
#' @export
haldane_mapping_function <-
function(x){
  r <- 0.5*(1-exp(-2*x))
  return(r)
}
